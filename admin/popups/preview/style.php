<?php
	...
	*/
	...
	// Close Button 
	$css .= '
	#lg-popup .lg-popup-close-btn {
		' . $btn_loc . '
	}	
	';
	$css .= '
	#lg-popup .lg-popup-close-btn.' . $close_type . ':before {
		' . $close_css . '
	}	
	#lg-popup .lg-popup-close-btn.' . $close_type . ':hover:before {
		' . $close_hover_css . '
	}	
	';
